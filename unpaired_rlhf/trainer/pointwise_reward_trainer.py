"""
Pointwise Reward Trainer. 

Code is based on the Hugging Face RewardTrainer class:
https://github.com/huggingface/trl/blob/v0.9.6/trl/trainer/reward_trainer.py
"""
